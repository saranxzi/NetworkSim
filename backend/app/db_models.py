...
class BlueprintVersion(Base):
    ...
    invariants: Mapped[Optional[list]] = mapped_column(JSON, default=list)
...
class SimulationRun(Base):
    ...
    invariant_violations: Mapped[Optional[dict]] = mapped_column(JSON, default=list)
...
class CloudPricing(Base):
    ...
    capacity_rps: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
